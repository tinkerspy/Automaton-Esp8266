...
Atm_esp8266_wifi& Atm_esp8266_wifi::trace( Stream & stream ) {
  Machine::setTrace( &stream, atm_serial_debug::trace,
    "ESP8266_WIFI\0EVT_START\0EVT_STOP\0EVT_TOGGLE\0EVT_TIMER\0EVT_CONNECT\0EVT_DISCONNECT\0ELSE\0IDLE\0START\0WAIT\0CHECK\0ACTIVE" );
  return *this;
}
